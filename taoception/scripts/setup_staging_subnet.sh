...
btcli config set --subtensor.network ws://127.0.0.1:9946 --wallet.path ~/.bittensor/wallets

# Create subnet and owner
btcli wallet faucet --wallet.name owner --max-successes 5 --no_prompt
btcli subnet create --wallet.name owner --wallet.hotkey default  --no_prompt
