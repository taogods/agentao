...
from taogod.validator.graders.float_grader import FloatGrader
...
class TrueSkillGrader(GraderInterface):
    ...
    def rank_trueskill(self, submissions: List[MinerSubmission]) -> List[float]:
        ...
        # We run the rating system twice for steadier results when we first
        # initialize the ratings
        num_runs = 1 if self.num_runs > 5 else 2
